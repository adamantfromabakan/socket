 ...
 *   DontOverwrite = False
 */
public class SWbemObjectSet implements com.linar.jintegra.RemoteObjRef, wbemdisp.ISWbemObjectSet {

  private static final String CLSID = "04b83d61-21ae-11d2-8b33-00600806d9b6";

  protected String getJintegraVersion() { return "64 BETA"; }

  // Interface delegates
  private wbemdisp.ISWbemObjectSetProxy d_ISWbemObjectSetProxy = null;

  /** Access this COM class's wbemdisp.ISWbemObjectSet interface */
  public wbemdisp.ISWbemObjectSet getAsISWbemObjectSet() { return d_ISWbemObjectSetProxy; }
   ...
   */
  public static SWbemObjectSet getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemObjectSet(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static SWbemObjectSet bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemObjectSet(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_ISWbemObjectSetProxy; }
  /**
   * Construct a SWbemObjectSet using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public SWbemObjectSet(Object obj) throws java.io.IOException {
    d_ISWbemObjectSetProxy = new wbemdisp.ISWbemObjectSetProxy(obj);
  }

  /**
   * Release a SWbemObjectSet.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_ISWbemObjectSetProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemObjectSetProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemObjectSetProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemObjectSetProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemObjectSetProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public java.util.Enumeration get_NewEnum  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemObjectSetProxy.get_NewEnum();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getCount  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemObjectSetProxy.getCount();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public wbemdisp.ISWbemSecurity getSecurity_  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemObjectSetProxy.getSecurity_();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
