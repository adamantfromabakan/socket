 ...
 *   DontOverwrite = False
 */
public class ISWbemPrivilegeProxy extends com.linar.jintegra.Dispatch implements wbemdisp.ISWbemPrivilege, java.io.Serializable {

  protected String getJintegraVersion() { return "64 BETA"; }

  static { wbemdisp.JIntegraInit.init(); }

  public static final Class targetClass = ISWbemPrivilege.class;

  public ISWbemPrivilegeProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, ISWbemPrivilege.IID, host, authInfo);
  }

  /** For internal use only */
  public ISWbemPrivilegeProxy() {}

  public ISWbemPrivilegeProxy(Object obj) throws java.io.IOException {
    super(obj, ISWbemPrivilege.IID);
  }

  protected ISWbemPrivilegeProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected ISWbemPrivilegeProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
      com.linar.jintegra.InterfaceDesc.add("26ee67bd-5804-11d2-8b4a-00600806d9b6", wbemdisp.ISWbemPrivilegeProxy.class, null, 7, MemberDesc.parseMemberDescFile(ISWbemPrivilegeProxy.class.getResource("ISWbemPrivilegeProxy.MemberDesc.xml")));
  }
}
