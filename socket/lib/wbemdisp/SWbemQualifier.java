...
/**
 * COM Class 'SWbemQualifier'. Generated 18.04.2014 15:20:21
 ...
 *   DontOverwrite = False
 */
public class SWbemQualifier implements com.linar.jintegra.RemoteObjRef, wbemdisp.ISWbemQualifier {

  private static final String CLSID = "04b83d5f-21ae-11d2-8b33-00600806d9b6";

  protected String getJintegraVersion() { return "64 BETA"; }

  // Interface delegates
  private wbemdisp.ISWbemQualifierProxy d_ISWbemQualifierProxy = null;

  /** Access this COM class's wbemdisp.ISWbemQualifier interface */
  public wbemdisp.ISWbemQualifier getAsISWbemQualifier() { return d_ISWbemQualifierProxy; }
   ...
   */
  public static SWbemQualifier getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemQualifier(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static SWbemQualifier bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemQualifier(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_ISWbemQualifierProxy; }
  /**
   * Construct a SWbemQualifier using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public SWbemQualifier(Object obj) throws java.io.IOException {
    d_ISWbemQualifierProxy = new wbemdisp.ISWbemQualifierProxy(obj);
  }

  /**
   * Release a SWbemQualifier.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_ISWbemQualifierProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemQualifierProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemQualifierProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public Object getValue  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.getValue();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setValue  (
    ...
    try {
      d_ISWbemQualifierProxy.setValue(varValue);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public String getName  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.getName();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isLocal  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.isLocal();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isPropagatesToSubclass  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.isPropagatesToSubclass();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setPropagatesToSubclass  (
    ...
    try {
      d_ISWbemQualifierProxy.setPropagatesToSubclass(bPropagatesToSubclass);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isPropagatesToInstance  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.isPropagatesToInstance();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setPropagatesToInstance  (
    ...
    try {
      d_ISWbemQualifierProxy.setPropagatesToInstance(bPropagatesToInstance);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isOverridable  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.isOverridable();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setIsOverridable  (
    ...
    try {
      d_ISWbemQualifierProxy.setIsOverridable(bIsOverridable);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isAmended  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemQualifierProxy.isAmended();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
