 ...
 *   DontOverwrite = False
 */
public class ISWbemMethodProxy extends com.linar.jintegra.Dispatch implements wbemdisp.ISWbemMethod, java.io.Serializable {

  protected String getJintegraVersion() { return "64 BETA"; }

  static { wbemdisp.JIntegraInit.init(); }

  public static final Class targetClass = ISWbemMethod.class;

  public ISWbemMethodProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, ISWbemMethod.IID, host, authInfo);
  }

  /** For internal use only */
  public ISWbemMethodProxy() {}

  public ISWbemMethodProxy(Object obj) throws java.io.IOException {
    super(obj, ISWbemMethod.IID);
  }

  protected ISWbemMethodProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected ISWbemMethodProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
      com.linar.jintegra.InterfaceDesc.add("422e8e90-d955-11d1-8b09-00600806d9b6", wbemdisp.ISWbemMethodProxy.class, null, 7, MemberDesc.parseMemberDescFile(ISWbemMethodProxy.class.getResource("ISWbemMethodProxy.MemberDesc.xml")));
  }
}
