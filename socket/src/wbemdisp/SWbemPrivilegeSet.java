 ...
 *   DontOverwrite = False
 */
public class SWbemPrivilegeSet implements com.linar.jintegra.RemoteObjRef, wbemdisp.ISWbemPrivilegeSet {

  private static final String CLSID = "26ee67be-5804-11d2-8b4a-00600806d9b6";

  protected String getJintegraVersion() { return "64 BETA"; }

  // Interface delegates
  private wbemdisp.ISWbemPrivilegeSetProxy d_ISWbemPrivilegeSetProxy = null;

  /** Access this COM class's wbemdisp.ISWbemPrivilegeSet interface */
  public wbemdisp.ISWbemPrivilegeSet getAsISWbemPrivilegeSet() { return d_ISWbemPrivilegeSetProxy; }
   ...
   */
  public static SWbemPrivilegeSet getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemPrivilegeSet(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static SWbemPrivilegeSet bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemPrivilegeSet(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_ISWbemPrivilegeSetProxy; }
  /**
   * Construct a SWbemPrivilegeSet using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public SWbemPrivilegeSet(Object obj) throws java.io.IOException {
    d_ISWbemPrivilegeSetProxy = new wbemdisp.ISWbemPrivilegeSetProxy(obj);
  }

  /**
   * Release a SWbemPrivilegeSet.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_ISWbemPrivilegeSetProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemPrivilegeSetProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemPrivilegeSetProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemPrivilegeSetProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemPrivilegeSetProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public java.util.Enumeration get_NewEnum  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemPrivilegeSetProxy.get_NewEnum();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getCount  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemPrivilegeSetProxy.getCount();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
