...
/**
 * COM Class 'SWbemLocator'. Generated 18.04.2014 15:20:21
 ...
 *   DontOverwrite = False
 */
public class SWbemLocator implements com.linar.jintegra.RemoteObjRef, wbemdisp.ISWbemLocator {

  private static final String CLSID = "76a64158-cb41-11d1-8b02-00600806d9b6";

  protected String getJintegraVersion() { return "64 BETA"; }

  // Interface delegates
  private wbemdisp.ISWbemLocatorProxy d_ISWbemLocatorProxy = null;

  /** Access this COM class's wbemdisp.ISWbemLocator interface */
  public wbemdisp.ISWbemLocator getAsISWbemLocator() { return d_ISWbemLocatorProxy; }
   ...
   */
  public static SWbemLocator getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemLocator(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static SWbemLocator bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemLocator(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_ISWbemLocatorProxy; }

  /**
   * Constructs a SWbemLocator on the local host.
   ...
   */
  public SWbemLocator() throws java.io.IOException, java.net.UnknownHostException {
    this("localhost");
  }

  /**
   * Construct a SWbemLocator on specified host.
   * @param     host  the host on which the object should be created
   * @exception java.io.IOException if there are problems communicating via DCOM 
   * @exception java.net.UnknownHostException if the host can not be found 
   */
  public SWbemLocator(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_ISWbemLocatorProxy = new wbemdisp.ISWbemLocatorProxy(CLSID, host, null);
  }

  /**
   * Construct a SWbemLocator using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public SWbemLocator(Object obj) throws java.io.IOException {
    d_ISWbemLocatorProxy = new wbemdisp.ISWbemLocatorProxy(obj);
  }

  /**
   * Release a SWbemLocator.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_ISWbemLocatorProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemLocatorProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemLocatorProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemLocatorProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemLocatorProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public wbemdisp.ISWbemServices connectServer  (
    ...
    try {
      return d_ISWbemLocatorProxy.connectServer(strServer,strNamespace,strUser,strPassword,strLocale,strAuthority,iSecurityFlags,objWbemNamedValueSet);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public wbemdisp.ISWbemSecurity getSecurity_  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemLocatorProxy.getSecurity_();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
