...
/**
 * COM Class 'SWbemSecurity'. Generated 18.04.2014 15:20:21
 ...
 *   DontOverwrite = False
 */
public class SWbemSecurity implements com.linar.jintegra.RemoteObjRef, wbemdisp.ISWbemSecurity {

  private static final String CLSID = "b54d66e9-2287-11d2-8b33-00600806d9b6";

  protected String getJintegraVersion() { return "64 BETA"; }

  // Interface delegates
  private wbemdisp.ISWbemSecurityProxy d_ISWbemSecurityProxy = null;

  /** Access this COM class's wbemdisp.ISWbemSecurity interface */
  public wbemdisp.ISWbemSecurity getAsISWbemSecurity() { return d_ISWbemSecurityProxy; }
   ...
   */
  public static SWbemSecurity getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemSecurity(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static SWbemSecurity bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemSecurity(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_ISWbemSecurityProxy; }
  /**
   * Construct a SWbemSecurity using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public SWbemSecurity(Object obj) throws java.io.IOException {
    d_ISWbemSecurityProxy = new wbemdisp.ISWbemSecurityProxy(obj);
  }

  /**
   * Release a SWbemSecurity.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_ISWbemSecurityProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemSecurityProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemSecurityProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemSecurityProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemSecurityProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public int getImpersonationLevel  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemSecurityProxy.getImpersonationLevel();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setImpersonationLevel  (
    ...
    try {
      d_ISWbemSecurityProxy.setImpersonationLevel(iImpersonationLevel);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public int getAuthenticationLevel  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemSecurityProxy.getAuthenticationLevel();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public void setAuthenticationLevel  (
    ...
    try {
      d_ISWbemSecurityProxy.setAuthenticationLevel(iAuthenticationLevel);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public wbemdisp.ISWbemPrivilegeSet getPrivileges  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemSecurityProxy.getPrivileges();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
