 ...
 * Description '<B>A single item from a Refresher</B>'
 *
 * Generator Options:
 *   AwtForOcxs = False
 ...
 *   DontOverwrite = False
 */
public class SWbemRefreshableItem implements com.linar.jintegra.RemoteObjRef, wbemdisp.ISWbemRefreshableItem {

  private static final String CLSID = "8c6854bc-de4b-11d3-b390-00105a1f473a";

  protected String getJintegraVersion() { return "64 BETA"; }

  // Interface delegates
  private wbemdisp.ISWbemRefreshableItemProxy d_ISWbemRefreshableItemProxy = null;

  /** Access this COM class's wbemdisp.ISWbemRefreshableItem interface */
  public wbemdisp.ISWbemRefreshableItem getAsISWbemRefreshableItem() { return d_ISWbemRefreshableItemProxy; }
   ...
   */
  public static SWbemRefreshableItem getActiveObject() throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemRefreshableItem(com.linar.jintegra.Dispatch.getActiveObject(CLSID));
  }
   ...
   * @exception com.linar.jintegra.AutomationException If there was an error attaching to the instance.
   */
  public static SWbemRefreshableItem bindUsingMoniker(String moniker) throws com.linar.jintegra.AutomationException, java.io.IOException {
    return new SWbemRefreshableItem(com.linar.jintegra.Dispatch.bindUsingMoniker(moniker));
  }

  /** J-Integra for COM internal method */
  public com.linar.jintegra.Dispatch getJintegraDispatch() {  return d_ISWbemRefreshableItemProxy; }
  /**
   * Construct a SWbemRefreshableItem using a reference to such an object returned from a COM server
   * @param     obj an object returned from a COM server
   * @exception java.io.IOException if there are problems communicating via DCOM 
   */
  public SWbemRefreshableItem(Object obj) throws java.io.IOException {
    d_ISWbemRefreshableItemProxy = new wbemdisp.ISWbemRefreshableItemProxy(obj);
  }

  /**
   * Release a SWbemRefreshableItem.
   */
  public void release() {
    com.linar.jintegra.Cleaner.release(d_ISWbemRefreshableItemProxy);
  }
  ...
  public Object getPropertyByName(String name) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.getPropertyByName(name);
  ...
  public Object getPropertyByName(String name, Object rhs) throws NoSuchFieldException, java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.getPropertyByName(name, rhs);
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    } catch(NoSuchFieldException noSuchFieldException) {
  ...
  public Object invokeMethodByName(String name, Object[] parameters) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemRefreshableItemProxy.invokeMethodByName(name, parameters);
  }
  ...
  public Object invokeMethodByName(String name) throws NoSuchMethodException, java.io.IOException, com.linar.jintegra.AutomationException {
    return d_ISWbemRefreshableItemProxy.invokeMethodByName(name, new Object[]{});
  }
  ...
  public int getIndex  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.getIndex();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public wbemdisp.ISWbemRefresher getRefresher  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.getRefresher();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public boolean isSet  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.isSet();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public wbemdisp.ISWbemObjectEx getObject  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.getObject();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
  ...
  public wbemdisp.ISWbemObjectSet getObjectSet  () throws java.io.IOException, com.linar.jintegra.AutomationException {
    try {
      return d_ISWbemRefreshableItemProxy.getObjectSet();
    } catch(com.linar.jintegra.AutomationException automationException) {
      automationException.fillInStackTrace();
      throw automationException;
    }
