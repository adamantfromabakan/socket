 ...
 *   DontOverwrite = False
 */
public class ISWbemEventSourceProxy extends com.linar.jintegra.Dispatch implements wbemdisp.ISWbemEventSource, java.io.Serializable {

  protected String getJintegraVersion() { return "64 BETA"; }

  static { wbemdisp.JIntegraInit.init(); }

  public static final Class targetClass = ISWbemEventSource.class;

  public ISWbemEventSourceProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, ISWbemEventSource.IID, host, authInfo);
  }

  /** For internal use only */
  public ISWbemEventSourceProxy() {}

  public ISWbemEventSourceProxy(Object obj) throws java.io.IOException {
    super(obj, ISWbemEventSource.IID);
  }

  protected ISWbemEventSourceProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  protected ISWbemEventSourceProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
      com.linar.jintegra.InterfaceDesc.add("27d54d92-0ebe-11d2-8b22-00600806d9b6", wbemdisp.ISWbemEventSourceProxy.class, null, 7, MemberDesc.parseMemberDescFile(ISWbemEventSourceProxy.class.getResource("ISWbemEventSourceProxy.MemberDesc.xml")));
  }
}
